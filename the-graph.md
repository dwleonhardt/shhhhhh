...
* Overall, the graph-node/subgraph setup is difficult to debug because of all the different pieces. For example, problems in the subgraph get logged on the graph-node, which is a fully separate process
